...
function slideKickOff() {
	...
	function showSlides() {
		var slidePrograms = {
            ...
            bulletin() {
                try {
                        if (weatherData.alerts.warnings.length != 0) {
                        ...
                        $('#bulletin-container #bulletin').on('finished', function() {$('#bulletin-container').fadeOut(0), $('#bulletin-container #bulletin').fadeOut(0), $('#bulletin-background').fadeOut(0), slideCallBack(), $('#lowerline').fadeIn(0)});
                    } else {
                        slideCallBack()
                    }
                } catch (error) {
