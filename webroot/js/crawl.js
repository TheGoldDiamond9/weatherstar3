    ...
    function showCrawls() {
        var crawlDisplays = {
            ...
            temperature() {
                ...
                $('#date-time').fadeIn(0)
                $('#marqueeholder').fadeOut(0)
                if (weatherData.currentConditions.feelsliketype == weatherData.currentConditions.temp) {
            ...
            wind() {
                ...
                $('#date-time').fadeIn(0)
                $('#marqueeholder').fadeOut(0)
                $('#lowerinfotext').text('WIND: ' + weatherData.currentConditions.wind)
                setTimeout(function() {
                    crawlCallBack()
                }, lowerDetailLength);
            },
            ...
            precip() {
                ...
                $('#date-time').fadeIn(0)
                $('#marqueeholder').fadeOut(0)
                //does not work, dont even bother
                setTimeout(function() {
                    crawlCallBack()
                }, lowerDetailLength);
            },
